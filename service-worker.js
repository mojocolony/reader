const CACHE='reader-v26.1';
const CORE=['./','./index.html','./styles.css?v=26.1','./app.js?v=26.1','./manifest.webmanifest','./icon.svg?v=26.1','./favicon-32.png?v=26.1','./apple-touch-icon.png?v=26.1','./icon-192.png?v=26.1','./icon-512.png?v=26.1'];

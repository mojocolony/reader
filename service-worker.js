const CACHE='reader-v26';
const CORE=['./','./index.html','./styles.css?v=26','./app.js?v=26','./manifest.webmanifest','./icon.svg?v=26','./favicon-32.png?v=26','./apple-touch-icon.png?v=26','./icon-192.png?v=26','./icon-512.png?v=26'];

const CACHE='reader-v26.5';
const CORE=['./','./index.html','./styles.css?v=26.5','./app.js?v=26.5','./manifest.webmanifest','./icon.svg?v=26.5','./favicon-32.png?v=26.5','./apple-touch-icon.png?v=26.5','./icon-192.png?v=26.5','./icon-512.png?v=26.5'];

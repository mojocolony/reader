const CACHE='reader-v26.3';
const CORE=['./','./index.html','./styles.css?v=26.3','./app.js?v=26.3','./manifest.webmanifest','./icon.svg?v=26.3','./favicon-32.png?v=26.3','./apple-touch-icon.png?v=26.3','./icon-192.png?v=26.3','./icon-512.png?v=26.3'];

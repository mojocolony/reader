const CACHE='reader-v26.9';
const CORE=['./','./index.html','./styles.css?v=26.9','./app.js?v=26.9','./manifest.webmanifest','./icon.svg?v=26.9','./favicon-32.png?v=26.9','./apple-touch-icon.png?v=26.9','./icon-192.png?v=26.9','./icon-512.png?v=26.9'];

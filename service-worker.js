const CACHE='reader-v26.7';
const CORE=['./','./index.html','./styles.css?v=26.7','./app.js?v=26.7','./manifest.webmanifest','./icon.svg?v=26.7','./favicon-32.png?v=26.7','./apple-touch-icon.png?v=26.7','./icon-192.png?v=26.7','./icon-512.png?v=26.7'];

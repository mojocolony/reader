const CACHE='reader-v26.4';
const CORE=['./','./index.html','./styles.css?v=26.4','./app.js?v=26.4','./manifest.webmanifest','./icon.svg?v=26.4','./favicon-32.png?v=26.4','./apple-touch-icon.png?v=26.4','./icon-192.png?v=26.4','./icon-512.png?v=26.4'];

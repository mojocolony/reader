const CACHE='reader-v26.8';
const CORE=['./','./index.html','./styles.css?v=26.8','./app.js?v=26.8','./manifest.webmanifest','./icon.svg?v=26.8','./favicon-32.png?v=26.8','./apple-touch-icon.png?v=26.8','./icon-192.png?v=26.8','./icon-512.png?v=26.8'];

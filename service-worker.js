const CACHE='reader-v26.6';
const CORE=['./','./index.html','./styles.css?v=26.6','./app.js?v=26.6','./manifest.webmanifest','./icon.svg?v=26.6','./favicon-32.png?v=26.6','./apple-touch-icon.png?v=26.6','./icon-192.png?v=26.6','./icon-512.png?v=26.6'];

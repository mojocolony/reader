const CACHE='reader-v26.2';
const CORE=['./','./index.html','./styles.css?v=26.2','./app.js?v=26.2','./manifest.webmanifest','./icon.svg?v=26.2','./favicon-32.png?v=26.2','./apple-touch-icon.png?v=26.2','./icon-192.png?v=26.2','./icon-512.png?v=26.2'];
